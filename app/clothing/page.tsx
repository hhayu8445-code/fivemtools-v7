...
import { Filter, SlidersHorizontal, Grid, List, Search, Shirt, Zap } from "lucide-react"

export default function ClothingPage() {
  const clothing = mockAssets.filter((asset) => asset.category === "clothing")
