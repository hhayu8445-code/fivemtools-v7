...
import { Grid, List, Search, Code, Zap } from "lucide-react"
            ...
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Browse our collection of premium and free scripts for your FiveM server.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="glass rounded-2xl p-4 mb-6">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                {/* Price tabs */}
                <div className="flex gap-1 bg-secondary/50 rounded-xl p-1 ml-auto">
