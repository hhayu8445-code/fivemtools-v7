...
import { SITE_LOGO, SPONSOR_BANNERS, FRAMEWORK_LOGOS } from "@/lib/constants"
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="ml-72">
        ...
        <div className="p-6 max-w-7xl mx-auto space-y-6">
          {/* Top Banner */}
          <div className="w-full h-[150px] md:h-[200px] overflow-hidden rounded-xl border border-border bg-card relative group">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            {/* Sidebar Left - Framework Sponsors */}
            <div className="hidden lg:block space-y-6">
              <div className="rounded-xl overflow-hidden border border-border bg-card p-4">
                <img src={FRAMEWORK_LOGOS.qbox || "/placeholder.svg"} alt="QBox Framework" className="w-full h-auto" />
              </div>
              <div className="rounded-xl overflow-hidden border border-border bg-card p-4">
                <img
                  src={FRAMEWORK_LOGOS.qbcore || "/placeholder.svg"}
                  alt="QBCore Framework"
                  className="w-full h-auto rounded-lg"
                />
              </div>
              <div className="rounded-xl overflow-hidden border border-border bg-card p-4">
                <img src={FRAMEWORK_LOGOS.esx || "/placeholder.svg"} alt="ESX Framework" className="w-full h-auto" />
              </div>
            </div>
