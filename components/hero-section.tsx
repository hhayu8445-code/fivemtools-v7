        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          ...
          <div className="grid grid-cols-2 gap-3 lg:gap-4">
            <div className="glass rounded-xl p-4 text-center card-hover">
              ...
              <p className="text-2xl font-bold text-foreground">{(stats.totalDownloads / 1000).toFixed(0)}K+</p>
              <p className="text-xs text-muted-foreground">Downloads</p>
            </div>
            <div className="glass rounded-xl p-4 text-center card-hover">
              <Users className="h-6 w-6 text-accent mx-auto mb-2" />
              <p className="text-2xl font-bold text-foreground">{(stats.totalMembers / 1000).toFixed(1)}K</p>
              <p className="text-xs text-muted-foreground">Members</p>
            </div>
            <div className="glass rounded-xl p-4 text-center card-hover">
              <img src={SITE_LOGO || "/placeholder.svg"} alt="Assets" className="h-6 w-6 mx-auto mb-2 object-contain" />
              <p className="text-2xl font-bold text-foreground">{stats.totalAssets.toLocaleString()}+</p>
