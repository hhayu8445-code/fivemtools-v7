        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-bold text-foreground">{mockStats.totalAssets.toLocaleString()}</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-bold text-foreground">{mockStats.totalDownloads.toLocaleString()}</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-bold text-foreground">{mockStats.totalMembers.toLocaleString()}</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-bold text-foreground">{mockStats.onlineUsers}</p>
            </div>
          </div>
