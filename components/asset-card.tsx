...
import { Download, Star, Zap, ArrowUpRight } from "lucide-react"
      ...
      <div className="group relative overflow-hidden rounded-2xl glass glass-hover">
        ...
        <div className="relative aspect-[16/10] overflow-hidden">
          ...
          <div className="absolute left-3 top-3 flex items-center gap-2">
            <Badge variant="secondary" className="bg-background/80 backdrop-blur-md text-xs border-0">
        ...
        <div className="p-4">
          <div className="mb-2 flex items-center gap-2 text-xs text-muted-foreground">
            <span className="uppercase font-medium text-primary/80">{asset.framework}</span>
